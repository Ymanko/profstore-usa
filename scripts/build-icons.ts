...
async function main() {
  ...
  console.log(`✨ Found ${files.length} SVG files in ${inputDirRelative}`);
  ...
  console.log(`✅ Generated sprite: ${outputFileRelative}`);
  ...
  console.log(`✅ Generated types: ${typesOutputFileRelative}`);

  console.log(`\n🎉 Done! Generated ${files.length} icons.`);
}

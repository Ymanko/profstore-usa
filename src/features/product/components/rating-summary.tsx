...
export function RatingSummary({ averageRating, totalReviews, breakdown, className }: RatingSummaryProps) {
  ...
  return (
    <div className={cn('space-y-5', className)}>
      <div className={cn('bg-sidebar-inactive space-y-5.75 rounded-xl px-5 py-8 md:p-7.5')}>
        <div className='flex items-center justify-between md:mx-auto md:grid md:justify-center md:gap-4'>
          {/* Average Rating */}

...
import { MobileMenu } from '@/components/layout/Header/extensions/MobileMenu';
import { MobileUserActions } from '@/components/layout/Header/extensions/MobileUserActions';
import { Searchbar } from '@/components/layout/Header/extensions/Searchbar';
import { UserActions } from '@/components/layout/Header/extensions/UserActions';
...
export const Header = () => {
  return (
    <header className='bg-primary-foreground border-border border-b'>
      {/*Top Bar*/}
      ...
      {/*Search Bar*/}
      <div className='bg-primary-foreground container grid grid-cols-2 items-center gap-4 py-5 md:grid-cols-[auto_1fr_auto] md:gap-6'>
        <SiteLogo />
